        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateOfPublish = table.Column<DateTime>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Groups", x => x.CourseId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppUserCourse", x => new { x.AppUsersId, x.CoursesId });
                    table.ForeignKey(
                        name: "FK_AppUserCourse_AspNetUsers_AppUsersId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "8e555bb4-f99a-4c01-9e10-f2f7080bec8d", null, "Instructor", "INSTRUCTOR" },
                    { "e668534f-264a-493c-86c2-c2cb96b75a20", null, "Student", "STUDENT" }
                });

            migrationBuilder.CreateIndex(
                name: "IX_AppUserCourse_CoursesId",
                table: "AppUserCourse",
                column: "CoursesId");
